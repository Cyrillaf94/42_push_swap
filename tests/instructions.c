...
/*   Updated: 2024/06/24 20:12:57 by cyril            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void test_ft_push(void)
{
    ...
    insert_node_tail(&list_to, create_node(20));
    ...
    CU_ASSERT_EQUAL(list_to->prev->data, 10);
	...
	CU_ASSERT_EQUAL(list_from->prev->data, 3);
	CU_ASSERT_EQUAL(list_to->prev->data, 4);

    ft_lstclear_circular(&list_from);
    ft_lstclear_circular(&list_to);
}
